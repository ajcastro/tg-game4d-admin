...
import PromotionSummaryFilters from '@/components/PromotionSummaryFilters.vue'
    ...
    return {
      ...
      ...makeTable({
        ...
        columns: [
          ...
          { key: 'running_number', label: 'Running #', sortable: true },
          { key: 'released_number', label: 'Released #', sortable: true },
          { key: 'claim_number', label: 'Claim #', sortable: true },
          { key: 'expired_number', label: 'Expired #', sortable: true },
