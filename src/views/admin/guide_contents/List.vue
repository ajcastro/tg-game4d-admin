    ...
    >
      ...
      >
        ...
        <template #cell(is_active)="data">
          <b-badge
            pill
            :variant="`light-${resolveIsActiveVariant(data.item.guide_content.is_active)}`"
            class="text-capitalize"
          >
            {{ data.item.guide_content.is_active ? 'Active' : 'Inactive' }}
          </b-badge>
        </template>
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item
              v-if="$can('view_detail', 'GuideContent') || $can('update', 'GuideContent')"
            ...
            <b-dropdown-item
              v-if="!data.item.guide_content.is_active && $can('activate', 'GuideContent')"
            ...
            <b-dropdown-item
              v-if="data.item.guide_content.is_active && $can('deactivate', 'GuideContent')"
...
export default {
  ...
  methods: {
    ...
    async edit(item) {
      this.$router.push({ name: 'guide_contents.edit', params: { id: item.id } })
    },
  },
}
</script>
